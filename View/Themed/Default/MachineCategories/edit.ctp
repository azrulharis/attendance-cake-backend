...
<div class="row"> 
  <div class="col-xs-12">
    <div class="x_panel tile">
      <div class="x_title">
        <h2><?php echo __('Edit Machine Category'); ?></h2>
        <div class="clearfix"></div>
      </div>
      <div class="x_content"> 
        <?php echo $this->Session->flash(); ?>
<div class="machineCategories form">
<?php echo $this->Form->create('MachineCategory', array('class' => 'form-horizontal form-label-left', 'id' => 'form')); ?>
