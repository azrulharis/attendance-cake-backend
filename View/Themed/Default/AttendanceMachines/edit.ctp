...
<div class="row"> 
  <div class="col-xs-12">
    <div class="x_panel tile">
      <div class="x_title">
        <h2><?php echo __('Edit Attendance Machine'); ?></h2>
        <div class="clearfix"></div>
      </div>
      <div class="x_content"> 
        <?php echo $this->Session->flash(); ?>
<div class="attendanceMachines form">
<?php echo $this->Form->create('AttendanceMachine'); ?>
			...
			<div class="form-group">
	    		...
	    		<div class="col-sm-9">
					<?php echo $this->Form->input('status', array('class' => 'form-control', 'label' => false)); ?>				</div>
						...
						<div class="form-group">
	    		<label class="col-sm-3">in_fuel</label>
	    		<div class="col-sm-9">
					<?php echo $this->Form->input('in_fuel', array('class' => 'form-control', 'label' => false)); ?>				</div>
			</div>
						<div class="form-group">
	    		<label class="col-sm-3">out_fuel</label>
	    		<div class="col-sm-9">
					<?php echo $this->Form->input('out_fuel', array('class' => 'form-control', 'label' => false)); ?>				</div>
			</div>
