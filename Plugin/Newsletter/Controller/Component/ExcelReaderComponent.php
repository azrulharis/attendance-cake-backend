...
//						$bgcolor = ($bgi & 0x3f80) >> 7;
	...
	public function copy($data){
			...
			if (!$this->_verifyMime($data['file']['name'])){
				$this->errors[] = 'The file must be an xls or xlsx!';
				return false;
			}
