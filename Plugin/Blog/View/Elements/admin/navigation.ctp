...
<!-- BEGIN SIDEBAR -->
	...
	<div id="MainMenu"  class="sidebar-nav" style="margin-top:70px;">  
			...
			?>
				...
				$image   =	'';
				$in	=	'';
				$BasicControllerarray = array('Countries','countries','States','states','Cities','cities');
				$BasicActionArray = array("admin_index","admin_view","admin_edit",'admin_add');
				if(in_array($this->params['controller'],$BasicControllerarray) && in_array($this->action, $BasicActionArray)) { 
				$mact = "start active open";
				$mspn = '<span class="selected"></span>';
				...
				?>
         		...
         		<a href="#demo19" class="list-group-item list-group-item-success" data-toggle="collapse" data-parent="#MainMenu">
                    <i class="fa fa-location-arrow"></i>Locations <?php echo $image ?>
                </a> 
            	<div class="collapse <?php echo $in; ?>" id="demo19"> 
           		<?php
					if(in_array($this->params['controller'],array('countries')) && in_array($this->action, $BasicActionArray))
				{
					$countries_class = 'active';	
				}
				else
				{
					$countries_class = '';
                    ...
                    array('escape' => false,'class'=>'list-group-item '.$countries_class)
                    );
                    ?>
               
               
                    <?php
					if(in_array($this->params['controller'],array('states')) && in_array($this->action, $BasicActionArray))
				{
					$states_class = 'active';	
				}
				else
				{
                    ...
                    array('escape' => false,'class'=>'list-group-item '.$states_class)
                    );
                    ?>
              
                    <?php
					if(in_array($this->params['controller'],array('cities')) && in_array($this->action, $BasicActionArray))
				{
					$cities_class = 'active';	
				}
				else
				{
                    ...
                    array('escape' => false,'class'=>'list-group-item '.$cities_class)
                    );
                    ?>
             		</div>
                 	<?php
				...
				$image   =	'';
				$in	=	'';
				$BasicControllerarray = array('Faqs','faqs','FaqCategories','faq_categories');
				$BasicActionArray = array("admin_index","admin_edit",'admin_add');
				if(in_array($this->params['controller'],$BasicControllerarray) && in_array($this->action, $BasicActionArray)) { 
				$mact = "start active open";
				$mspn = '<span class="selected"></span>';
				$in	=	'in';
				...
				?>
         		...
         		<a href="#demo23" class="list-group-item list-group-item-success" data-toggle="collapse" data-parent="#MainMenu">
                    <i class="fa fa-question-circle"></i>Faqs <?php echo $image ?>
                </a> 
            	<div class="collapse <?php echo $in; ?>" id="demo23"> 
           		<?php
				if(in_array($this->params['controller'],array('faq_categories')) && in_array($this->action, $BasicActionArray))
				{
				...
				else
				{
                    ...
                    array('escape' => false,'class'=>'list-group-item '.$category_class)
                    );
                    ?>
               
               
                    <?php
					if(in_array($this->params['controller'],array('faqs')) && in_array($this->action, $BasicActionArray))
				{
					$faq_class = 'active';	
				}
				else
				{
                    ...
                    array('escape' => false,'class'=>'list-group-item '.$faq_class)
                    );
                    ?>
             		</div>
