<?php
App::uses('SchoolClassSubjectsController', 'Controller');

/**
 * SchoolClassSubjectsController Test Case
 *
 */
class SchoolClassSubjectsControllerTest extends ControllerTestCase {
