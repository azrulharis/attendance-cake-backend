<?php
App::uses('UniversityCourseSubjectsController', 'Controller');

/**
 * UniversityCourseSubjectsController Test Case
 *
 */
class UniversityCourseSubjectsControllerTest extends ControllerTestCase {
